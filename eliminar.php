		...
		<header class="header">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
			    <ul class="nav navbar-nav">
				 	...
				 	<li class="active"><a href="eliminar.php"><b>ELIMINAR PROYECTO</b></a></li>
		...
		<div class="container" id="medio">
			<form class="form-inline" method="post" >
				...
				<div class="form-group">
				    ...
				    <input type="text" class="form-control" name="ident"  placeholder="Identificador proyecto">
				</div>
				  <button type="submit" name="buscar" class="btn btn-info"><span class="glyphicon glyphicon-search">&nbsp;</span><b>Buscar</b></button></center>
			</form><br>
			<?php
					include('controlador/consultarEliminar.php');
				?>
		</div>
		<footer>
